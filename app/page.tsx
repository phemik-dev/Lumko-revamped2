    ...
    <>
      ...
      <main>
        <section className="border-b border-muted-gray bg-white">
          <div className="mx-auto grid w-full max-w-[1240px] gap-10 px-6 py-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-7 max-w-xl text-2xl leading-relaxed text-charcoal/72">
        ...
        <Section subtitle="LumkoMDX removes it." title="Healthcare data has always required a tradeoff.">
          <div className="grid gap-8 lg:grid-cols-[1fr_120px_1fr]">
            ...
            <div className="rounded-xl border border-teal/35 bg-[#f8fcfc] p-8">
            ...
            {[
              ...
              <div className="flex gap-4" key={title}>
                ...
                <div>
                  ...
                  <p className="mt-2 text-lg text-charcoal/70">{body}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="border-b border-muted-gray bg-[#021b43]">
          <div className="mx-auto grid w-full max-w-[1240px] gap-8 px-6 py-14 lg:grid-cols-[1.1fr_1fr_1fr_1fr]">
            <h3 className="text-[44px] leading-tight font-semibold text-white">Privacy is not a feature. It is a property of the system.</h3>
            {[
